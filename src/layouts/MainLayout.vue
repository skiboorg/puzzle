        ...
        <div class="container">
          <div class="flex items-center justify-between">
            ...
            <div style="width: 300px" class="flex items-center justify-between gt-sm">
              ...
              <q-btn  flat dense round to="/profile" :class="[$route.fullPath === '/profile' ? 'active' : '']">
              ...
              <q-btn flat dense round to="/stats" :class="[$route.fullPath === '/stats' ? 'active' : '']">
              ...
              <q-btn flat dense round to="/rules" :class="[$route.fullPath === '/rules' ? 'active' : '']">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <q-btn flat dense round to="/about" :class="[$route.fullPath === '/about' ? 'active' : '']">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div  class="flex items-center gt-sm user-stats">
              ...
              <q-btn to="/profile" class=" text-mira" no-caps outline label="withdraw"/>
            </div>
            <div  class="flex items-center gt-sm">
              <div class="q-mr-lg">
                <p class="no-margin ellipsis" style="max-width: 100px">{{$user.user.wallet}}</p>
